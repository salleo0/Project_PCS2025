...
The program must also handle a 6-tuple input: (p, q, b, c, id_vertex_1, id_vertex_2).
...
The complete C++ source code (hosted on this shared GitHub repository).

The corresponding UML documentation that describes the logical units defined in the source code.Programming and Scientific Computing Project: Geodetic Polyhedra
...
The corresponding UML documentation that describes the logical units defined in the source code.
